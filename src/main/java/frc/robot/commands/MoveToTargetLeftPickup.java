...
public class MoveToTargetLeftPickup extends CommandBase {
  ...
  public MoveToTargetLeftPickup(SwerveSubsystem swerveSubsystem) {
    field = new Field2d();
  ...
  public void initialize() {
    ...
    PathPlannerTrajectory traj = PathPlanner.generatePath(new PathConstraints(2, 2), 
                                                          ...
                                                          new PathPoint(new Translation2d(( usedCam.getX() - PhotonVision.CAM_TO_FIDUCIAL_METERS ) * dir - 0.5,(usedCam.getY() + 1.17475)*dir), Rotation2d.fromDegrees(0), Rotation2d.fromDegrees(0)));
